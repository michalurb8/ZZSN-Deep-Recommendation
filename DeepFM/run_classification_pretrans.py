...
if __name__ == "__main__":
    # 1. Load pretrensformed data and set data types to save RAM:
    #  uses approx 6GB for dataset loading
    #  needs ~20 GB to load dataset and train model
